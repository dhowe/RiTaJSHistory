(function(window, undefined) {
    ...
    RiLexicon.prototype = {
         ...
         * 
         * @param {string} - word
         * @param int - minimum edit distance for matches (optional, default=1)
         * @param boolean - whether to return only words that match the length of the input word (optional, default=true)
         * 
         ...
         *
         * @param {string} - word
         * @param int - minimum length of return word (optional, default=4)
         * @return array - matching words 
         */
         ...
         *  
         * @param regex  (string or object) - pattern to match (optional)
         * @param boolean - randomizes the order (default=false)
         ...
         * @param char
         * @return boolean - true if c is consonant
         */
         ...
         * @return boolean - true if the word exists in the lexicon
         */
         ...
         * but instead just returns false. TODO
         * 
         * @param {string} word1
         * @param {string} word2
         * 
         * @return boolean true if the two words rhyme, else false.
         */
         ...
         * @param {string} - the word
         * @return array  - strings, the rhymes for a given word, or empty array if none are found
         */
         ...
         * @return array of string of alliterations
         */
         ...
         * @param {string} word1
         * @param {string} word2
         * @return boolean - true if word1.equals(word2) and false if either (or both) are null;
         */
         ...
         * delimited by dashes (phonemes) and semi-colons (words), e.g., "dh-ax:d-ao-g:r-ae-n:f-ae-s-t" 
         * for the 4 syllables of the phrase 'The dog ran fast', or null if no text has been input.
         * 
         * @param {string} input
         * @return String containing the phonemes for each syllable of each word of the input text
         */
         ...
         * e.g., "dh:ax:d:ao:g:r:ae:n:f:ae:s:t", or null if no text has been input.
         * 
         * @param {string} input
         * @return String containing all phonemes for the input text, delimited by semi-colons, 
         */
         ...
         * e.g., "0:1:0:1", with 1's meaning 'stressed', and 0's meaning 'unstressed', 
         * or null if no text has been input.
         * 
         * @param {string} input
         * @return String containing the stresses for each syllable of the input text
         */
